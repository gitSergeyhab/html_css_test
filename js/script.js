...
const srviceTexts = [
    'Мы с удовольствием доставим ваш товар прямо к вашему подъезду совершенно бесплатно!<br />Ведь мы неплохо заработаем, <br />поднимая его на ваш этаж!',
...
const srviceImgSrc = ['serv_img0', 'serv_img1', 'serv_img2']
...
services.forEach((serv, i) => {
    serv.addEventListener('click', () => {
        ...
        srviceImgSrc.forEach( clas => servImg.classList.remove(clas) )
        servImg.classList.add(srviceImgSrc[i]);
    });
